...
public class CustomerController {
    ...
    public ResponseEntity<CustomerDetailsDTO> fetchCustomerInformationByMobileNumber(@RequestParam String mobileNumber){
        log.info("Fetching customer details");
        return new ResponseEntity<>(customerService.fetchCustomerInfo(mobileNumber), HttpStatus.OK);
    }
